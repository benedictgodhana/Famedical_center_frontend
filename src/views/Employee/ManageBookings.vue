  ...
  <div>
    ...
    <v-container>
      ...
      <v-card variant="outlined" style="width: 100%; margin-top: 20px;">
       ...
       <v-card-title style="background: purple;color:white">My Appointments</v-card-title>
       ...
       <v-card-text style="margin-top: -10px;">
         ...
         >
           <template v-slot:item.action="{ item }">
             ...
             <v-btn color="transparent" elevation="0" style="text-transform: capitalize;" @click="viewBookingDetails(item)"><v-icon color="red">mdi-eye</v-icon></v-btn>        
               </template>
         </v-data-table>
       </v-card-text>
     </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { title: 'Student Name', value: 'customer_name' },
        { title: 'Student Email', value: 'customer_email' },
