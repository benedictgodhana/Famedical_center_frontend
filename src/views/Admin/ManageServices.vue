<template>
  <v-container>
    ...
    <v-card variant="outlined" style="width: 100%; margin-top: 20px;">
      <v-card-title style="background:purple;color:white">Medical Services Table</v-card-title>
      <v-card-text style="margin-top: 20px;">
        ...
        <v-btn @click="openAddServiceDialog" color="purple" style="border-radius: 5px;text-transform: capitalize;"><span class="mdi mdi-stethoscope"></span>Add Service</v-btn>
      </v-card-text>
      <v-card-text style="margin-top: 20px;">
        <v-data-table
          :headers="headers"
