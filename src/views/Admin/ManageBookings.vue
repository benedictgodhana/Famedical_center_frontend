<template>
    <v-container>
      ...
      <v-card variant="outlined" style="width: 100%; margin-top: 20px;">
        ...
        <v-card-title style="background:purple;color:white">All Appointments Table</v-card-title>
        ...
        <v-card-text style="margin-top: 20px;">
          ...
          >
            <template v-slot:item.action="{ item }">
              <v-btn color="transparent" elevation="0" class="mr-4" @click="openEditDialog(item)" style="text-transform:capitalize;"><span style="color:green" class="mdi mdi-pencil"></span></v-btn>
              <v-btn color="transparent" elevation="0" @click="deleteUserDialog(item)"  style="text-transform:capitalize;"><span style="color:red" class="mdi mdi-delete"></span></v-btn>
            </template>
          </v-data-table>
        </v-card-text>
      </v-card>
