  ...
  <div>
    ...
    <v-container>
      ...
      <v-card variant="outlined" style="width: 100%; margin-top: 20px;">
       ...
       <v-card-title style="background:purple;color:white">My Appointment History</v-card-title>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { title: 'Doctor Booked', value: 'employee_name' },
        { title: 'Medical Service booked', value: 'service_name' },
        { title: 'Date', value: 'date_time' },
        { title: 'Medical Center', value: 'location' },
